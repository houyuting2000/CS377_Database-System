<?php
    ...
    print("<h1>Here are the current posts for $cnumber $semester $year under tag $tag:</h1>");
...
$query = "SELECT user_id, post_date from post_tags where cnumber = '$cnumber' and semester='$semester' and year='$year' and tag LIKE '%$tag%' order by post_date;";
# execute query
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    # post title
    $query111 = "SELECT post_title from post where cnumber='$cnumber' and semester='$semester' and year='$year' and post_date='$array[1]' and user_id='$array[0]';";
